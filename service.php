<?php 	
		...
		if(isset($_GET['fil'])){
			...
			$passed_filter = $_GET['fil'];
			
			switch($passed_filter){
				case "service_engineer":
				$team_filter = "service_engineer";
				$local_path = "".$_SERVER['PHP_SELF']."?fil=service_engineer&";
				break;
				
				case "team_lead":
				$team_filter = "team_lead";
				$local_path = "".$_SERVER['PHP_SELF']."?fil=team_lead&";
				break;
				
				case "rep":
				$team_filter = "rep";
				$local_path = "".$_SERVER['PHP_SELF']."?fil=rep&";
				break;
			...
			if ($duration == 12){
				...
				$title = "Summary from $start_date_twelve to $stop_date (12 months)";
					...
					$title = "Summary from $start_date_six to $stop_date (6 months)";
						...
						$dur_filter = "".$dashboard_table."_data_twelve";
						$title	= "CONTROL DATA FROM 1 AUGUST 2012 TO 30 FEBRUARY 2013";
					}
...
<html>
  <head>
  <title>Alerton Service Dashboard</title>
  ...
  <body>
  	...
  	<div class="container-fluid">
  		<div class="row-fluid header">
  			<div class="span10"><h2>Alerton Service Dashboard</h2></div>
  			<div class="span2">
		  			...
		  			<div class="container">
			  			...
			  			<a class="btn btn-navbar" data-toggle="collapse" data-target=".nav-collapse">
				  			<ul class="nav">
						  		...
						  		<li>
						  			<a href="service.php?fil=service_engineer&">Service Engineer</a>
						  		</li>
						  		<li><a href="service.php?fil=team_lead&">Team Lead</a></li>
						  		<li><a href="service.php?fil=rep&">Rep</a></li>
						  	<!--	<li><a href="service.php?fil=team&">Branch</a></li> -->
  		...
  		<div class="container-fluid">
  			<div class="row-fluid">
  				  <?php
  				  	retrieve_service_data($team_filter,$dur_filter,null,null);
  				  ?>
